...
import { AlertCircle, Anchor, ArrowLeft, ArrowUp, Award, Calculator, Check, CheckCircle2, ChevronLeft, ChevronRight, ClipboardCheck, ExternalLink, FileCheck, FileText, FolderCheck, Globe2, Headphones, Info, Loader2, Lock, Mail, MapPin, Menu, MessageCircle, Package, PackageCheck, Phone, Plane, Plus, Send, ShieldCheck, Ship, Stamp, Target, TrendingUp, Users, X, Zap } from "lucide-react";
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(MapPin, {
					...
					"aria-hidden": true
				}), /* @__PURE__ */ jsx("span", { children: "جمهورية مصر العربية" })]
			}), /* @__PURE__ */ jsxs("div", {
				className: "flex items-center gap-4",
				children: [SITE.phones.map((p) => /* @__PURE__ */ jsxs("a", {
					href: p.href,
...
//#endregion
//#region src/assets/asn-logo.png
		...
		children: [/* @__PURE__ */ jsxs("nav", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("ul", {
					...
					children: NAV_ITEMS.map((item) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", {
						href: item.href,
			...
			children: /* @__PURE__ */ jsxs("ul", {
				...
				children: [NAV_ITEMS.map((item) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", {
					...
					children: [/* @__PURE__ */ jsx(MessageCircle, { className: "size-4" }), "استشارة مجانية"]
				})]
			})
		}) })]
	});
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			/* @__PURE__ */ jsx(AnimatePresence, {
				mode: "sync",
				children: slides.map((s, idx) => idx === i ? /* @__PURE__ */ jsxs(motion.div, {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-l from-navy/85 via-navy/55 to-navy/30" }),
						/* @__PURE__ */ jsx("div", {
							className: "absolute inset-0",
						...
						children: [/* @__PURE__ */ jsx(AnimatePresence, {
							...
							children: /* @__PURE__ */ jsxs(motion.div, {
								...
								children: [/* @__PURE__ */ jsxs("span", {
									...
									children: [/* @__PURE__ */ jsx("span", { className: "size-1.5 rounded-full bg-accent animate-pulse" }), slides[i].kicker]
								}), /* @__PURE__ */ jsx("h1", {
							...
							children: [/* @__PURE__ */ jsxs("a", {
								...
								children: [/* @__PURE__ */ jsx(MessageCircle, { className: "size-5" }), "استشارة مجانية"]
							}), /* @__PURE__ */ jsx("a", {
								href: "#contact",
			...
			children: [/* @__PURE__ */ jsxs("div", {
					...
					children: /* @__PURE__ */ jsxs(Reveal, {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsx("p", { children: "ASN شركة استيراد وتصدير جمركي رائدة في جمهورية مصر العربية، وتعتبر من أهم شركات الشحن الدولي الحاصلة على ترخيص IATA." }),
									/* @__PURE__ */ jsx("p", { children: "تمتلك الشركة خبرات واسعة في تقديم خدمات الشحن وإنهاء الإجراءات القانونية والجمركية. تُركز على تلبية متطلبات العميل، ونسعى لمواكبة التطويرات، وإتمام عملنا بأسرع وأسهل الطرق، وأكثرها أمانًا وتوفيرًا لعملائنا." }),
									/* @__PURE__ */ jsx("p", { children: "شركة تخليص جمركي متخصصة في جميع الخدمات اللوجستية الخاصة بالاستيراد والتصدير من وإلى جمهورية مصر العربية. نتعاقد مع أفضل شركات شحن دولي وأهم شركات الشحن العالمية لتلبية احتياجات عملائنا بأسعار تنافسية، وجودة عالية." })
								]
							}),
							/* @__PURE__ */ jsxs("div", {
								className: "mt-8",
				...
				children: /* @__PURE__ */ jsx("div", {
					...
					children: stats.map((s) => /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("div", { className: "absolute -top-6 -left-6 size-24 rounded-full gradient-primary opacity-5 group-hover:opacity-10 transition" }),
							/* @__PURE__ */ jsx(s.icon, {
...
//#endregion
//#region src/assets/team.jpg
var team_default = "/assets/team-CZGcn-B5.jpg";
//#endregion
//#region src/sections/Team.tsx
var timeline = [
	{
		icon: FileText,
...
function Team() {
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				className: "grid lg:grid-cols-2 gap-12 lg:gap-20 items-center",
				children: [/* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs(Reveal, {
					dir: "right",
					children: [
						/* @__PURE__ */ jsx("span", {
							className: "inline-block text-xs font-black tracking-widest text-secondary uppercase",
						...
						/* @__PURE__ */ jsxs("h2", {
							className: "mt-3 text-3xl sm:text-4xl lg:text-5xl font-black text-navy",
							children: ["فريق ", /* @__PURE__ */ jsx("span", {
								className: "text-gradient",
								children: "العمل"
							})]
						}),
						/* @__PURE__ */ jsxs("div", {
							className: "mt-6 space-y-4 text-navy-light leading-loose text-[15px] sm:text-base",
							children: [/* @__PURE__ */ jsx("p", { children: "تضم شركة ASN فريق عمل متميز ومتخصص في شؤون الجمارك، وإنهاء كافة الإجراءات بجميع المنافذ الجمركية. يمتلك فريقنا الخبرة والكفاءة التي تمكنه من إتمام إجراءات الاستيراد والتصدير والتخليص الجمركي في وقت قياسي داخل جميع موانئ الجمهورية." }), /* @__PURE__ */ jsx("p", { children: "فريق عمل ASN مُدرب على أعلى مستوى من المهارة والاحترافية، لتوفير أقصى درجات الالتزام بمعايير الخدمة. نهتم دائمًا بإعداد المستندات اللازمة لضمان إتمام عمليات العملاء، دون استنزاف الوقت والمال نتيجة أي تأخير." })]
						})
					]
				}) }), /* @__PURE__ */ jsx(Reveal, {
					dir: "left",
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("img", {
							...
							height: 900,
							loading: "lazy"
						}), /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-navy/40 to-transparent" })]
					})
				})]
				...
				children: [/* @__PURE__ */ jsxs("h3", {
					...
					children: ["مراحل عمل ", /* @__PURE__ */ jsx("span", {
						className: "text-gradient",
						children: "ASN"
					})]
				}), /* @__PURE__ */ jsxs("div", {
					className: "relative",
					children: [
						/* @__PURE__ */ jsx("div", { className: "absolute top-8 right-8 left-8 h-0.5 bg-divider hidden md:block" }),
						/* @__PURE__ */ jsx("div", {
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: timeline.map((step, idx) => /* @__PURE__ */ jsx(Reveal, {
								dir: "up",
								delay: idx * .1,
								children: /* @__PURE__ */ jsxs("div", {
...
function Services() {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("div", { className: "absolute top-20 right-10 size-72 rounded-full bg-accent/30 blur-3xl" }), /* @__PURE__ */ jsx("div", { className: "absolute bottom-20 left-10 size-72 rounded-full bg-secondary/20 blur-3xl" })]
		}), /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs(Reveal, {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("h2", {
							className: "mt-3 text-3xl sm:text-4xl lg:text-5xl font-black text-navy",
							children: ["خدمات", /* @__PURE__ */ jsx("span", {
								className: "text-gradient",
								children: "نا"
							})]
						}),
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: services$1.map((s, i) => /* @__PURE__ */ jsx(Reveal, {
						dir: "up",
						delay: i * .08,
						children: /* @__PURE__ */ jsxs("article", {
							...
							children: [
								/* @__PURE__ */ jsx("div", { className: "absolute -top-16 -left-16 size-40 rounded-full gradient-primary opacity-0 blur-2xl transition group-hover:opacity-20" }),
								/* @__PURE__ */ jsx("div", {
								...
								/* @__PURE__ */ jsxs("a", {
									...
									children: ["استشارة مجانية", /* @__PURE__ */ jsx(ArrowLeft, { className: "size-4 transition group-hover:-translate-x-1" })]
								})
							]
						})
					}, s.title))
...
//#endregion
//#region src/assets/world-map.jpg
var world_map_default = "/assets/world-map-DVUbJhvP.jpg";
//#endregion
//#region src/sections/WhyASN.tsx
var features = [
...
function WhyASN() {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-navy via-navy/85 to-navy" }),
			/* @__PURE__ */ jsx("div", {
				className: "container-asn relative",
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs(Reveal, {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("h2", {
								...
								children: ["لماذا ", /* @__PURE__ */ jsx("span", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", { className: "absolute -top-8 -left-8 grid place-items-center size-28 rounded-full bg-accent/20 blur-2xl" }), /* @__PURE__ */ jsxs("div", {
...
//#endregion
//#region src/sections/OurMessage.tsx
var cards = [
	{
		icon: TrendingUp,
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: [/* @__PURE__ */ jsxs(Reveal, {
				...
				children: [/* @__PURE__ */ jsx("span", {
					...
					className: "mt-3 text-3xl sm:text-4xl lg:text-5xl font-black text-navy",
					children: ["رسالت", /* @__PURE__ */ jsx("span", {
						className: "text-gradient",
						children: "نا"
					})]
				})]
				...
				children: cards.map((c, i) => /* @__PURE__ */ jsx(Reveal, {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 h-1.5 w-full gradient-primary scale-x-0 origin-right transition-transform duration-500 group-hover:scale-x-100" }),
							/* @__PURE__ */ jsx("div", {
								className: "grid place-items-center size-16 rounded-2xl gradient-primary text-white shadow-soft",
								children: /* @__PURE__ */ jsx(c.icon, {
									className: "size-8",
									strokeWidth: 1.75
								})
							}),
...
//#endregion
//#region src/sections/ConversionCTA.tsx
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsx(Reveal, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", { className: "absolute -top-24 -left-24 size-72 rounded-full bg-white/10 blur-3xl" }),
						/* @__PURE__ */ jsx("div", { className: "absolute -bottom-24 -right-24 size-72 rounded-full bg-accent/30 blur-3xl" }),
						/* @__PURE__ */ jsxs("svg", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("a", {
									...
									children: [/* @__PURE__ */ jsx(Send, { className: "size-5" }), "تواصل معنا"]
								})]
							})]
						})
					]
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(Reveal, {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("h2", {
						className: "mt-3 text-3xl sm:text-4xl lg:text-5xl font-black text-navy",
						children: ["أهم ", /* @__PURE__ */ jsx("span", {
							className: "text-gradient",
							children: "الأسئلة"
						})]
					}),
...
function Contact() {
	...
	const onSubmit = async (e) => {
		...
		try {
			...
			else await emailjs.send(serviceId, templateId, data, { publicKey });
			setStatus("success");
			e.target.reset();
			...
			children: [
				/* @__PURE__ */ jsxs(Reveal, {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("h2", {
							className: "mt-3 text-3xl sm:text-4xl lg:text-5xl font-black text-navy",
							children: ["تواصل ", /* @__PURE__ */ jsx("span", {
								className: "text-gradient",
								children: "معنا"
							})]
						}),
									...
									children: /* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("div", {
											...
											children: [/* @__PURE__ */ jsx("h3", {
												...
												children: SITE.phones.map((p) => /* @__PURE__ */ jsx("a", {
													href: p.href,
													dir: "ltr",
										...
										children: [/* @__PURE__ */ jsx("div", {
											...
											children: [
												...
												/* @__PURE__ */ jsxs("a", {
													...
													children: ["فتح في خرائط جوجل", /* @__PURE__ */ jsx(ExternalLink, { className: "size-4" })]
												})
											]
										})]
									})
						...
						children: /* @__PURE__ */ jsxs("form", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("button", {
									...
									children: status === "loading" ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "size-5 animate-spin" }), " جارٍ الإرسال..."] }) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Send, { className: "size-5" }), " إرسال الرسالة"] })
								}),
								status === "success" && /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "size-5 shrink-0 text-green-600" }), /* @__PURE__ */ jsx("span", { children: "تم إرسال رسالتك بنجاح، وسيقوم فريق ASN بالتواصل معك في أقرب وقت." })]
								}),
								status === "error" && /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(AlertCircle, { className: "size-5 shrink-0 text-red-600" }), /* @__PURE__ */ jsx("span", { children: "تعذر إرسال الرسالة، يرجى المحاولة مرة أخرى." })]
								})
							]
						})
					})]
...
function Footer() {
	return /* @__PURE__ */ jsxs("footer", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			"aria-hidden": true,
			children: [/* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 size-96 rounded-full bg-secondary blur-3xl" }), /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 size-96 rounded-full bg-accent blur-3xl" })]
		}), /* @__PURE__ */ jsxs("div", {
			className: "container-asn relative",
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h4", {
						...
						children: NAV_ITEMS.map((n) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", {
							href: n.href,
					...
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h4", {
						...
						className: "space-y-2.5",
						children: services.map((s) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", {
							href: "#services",
							className: "text-sm text-white/75 hover:text-accent transition",
							children: s
						}) }, s))
					...
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h4", {
						...
						className: "space-y-3",
						children: [
							SITE.phones.map((p) => /* @__PURE__ */ jsxs("li", {
								className: "flex items-center gap-2.5",
								children: [/* @__PURE__ */ jsx(Phone, { className: "size-4 text-accent shrink-0" }), /* @__PURE__ */ jsx("a", {
									href: p.href,
									dir: "ltr",
							...
							/* @__PURE__ */ jsxs("li", {
								className: "flex items-center gap-2.5",
								children: [/* @__PURE__ */ jsx(Mail, { className: "size-4 text-accent shrink-0" }), /* @__PURE__ */ jsx("a", {
									href: `mailto:${SITE.email}`,
							...
							/* @__PURE__ */ jsxs("li", {
								className: "flex items-center gap-2.5",
								children: [/* @__PURE__ */ jsx(MapPin, { className: "size-4 text-accent shrink-0" }), /* @__PURE__ */ jsx("span", {
				...
				children: [/* @__PURE__ */ jsx("p", {
					...
					children: [/* @__PURE__ */ jsx(ArrowUp, { className: "size-4" }), "العودة للأعلى"]
				})]
			})]
		})]
	});
